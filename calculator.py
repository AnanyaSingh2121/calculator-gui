...
entry=Entry(cal,font=('ariel',20,'bold'),bd=30,insertwidth=3,bg='cyan',
...
button7= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='7',
                font=('ariel',20,'bold'),command=lambda:btnclick(7))           
button7.grid(row=1,column=0)
button8= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='8',
                font=('ariel',20,'bold'),command=lambda:btnclick(8))           
button8.grid(row=1,column=1)
button9= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='9',
                font=('ariel',20,'bold'),command=lambda:btnclick(9))           
button9.grid(row=1,column=2)
buttonadd= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='+',
                font=('ariel',20,'bold'),command=lambda:btnclick('+'))           
...
button4= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='4',
                font=('ariel',20,'bold'),command=lambda:btnclick(4))           
button4.grid(row=2,column=0)
button5= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='5',
                font=('ariel',20,'bold'),command=lambda:btnclick(5))           
button5.grid(row=2,column=1)
button6= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='6',
                font=('ariel',20,'bold'),command=lambda:btnclick(6))           
...
button1= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='1',
                font=('ariel',20,'bold'),command=lambda:btnclick(1))           
button1.grid(row=3,column=0)
button2= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='2',
                font=('ariel',20,'bold'),command=lambda:btnclick(2))           
button2.grid(row=3,column=1)
button3= Button(cal,padx=16,pady=16,bd=8,fg='black',
                text='3',
                font=('ariel',20,'bold'),command=lambda:btnclick(3))           
